...
class TestArithmetics(unittest.TestCase):
    ...
    def test_fmod(self):
        ...
        raise TypeError("0: {}, 1: {}, 2: {}, 3: {}, 4: {}, 5: {}, 6: {}, 7:{}".format(self.a_scalar, a_float.gpu(), ht.array([[2.0],[2.0]]).gpu(), result, ht.array([self.a_scalar]).gpu(), ht.fmod(self.a_scalar, self.a_scalar).gpu(), ht.float32([0.0,0.0]).gpu(), zero_tensor))
