...
class TestArithmetics(unittest.TestCase):
    ...
    def test_fmod(self):
        ...
        raise TypeError("0: {}, 1: {}, 2: {}, 3: {}, 4: {}, 5: {}, 6: {}, 7:{}".format(self.a_scalar, a_float.device.device_id, ht.array([[2.0],[2.0]]).device.device_type, result, ht.array([self.a_scalar]).device.torch_device, ht.fmod(self.a_scalar, self.a_scalar), ht.float32([0.0,0.0]), zero_tensor))
