...
class TestArithmetics(unittest.TestCase):
    ...
    def test_fmod(self):
        ...
        raise TypeError("0: {}, 1: {}, 2: {}, 3: {}, 4: {}".format(a_float.device.device_type, ht.array([[2.0],[2.0]]).device.device_type, ht.fmod(self.a_scalar, self.a_scalar).device.device_type))
